...
// Whale variables
float whaleX = 1970;  //posisi muncul
float whaleY = 100;  //posisi ketinggian
float whaleSpeedX = 8;  //kecepatan berenang
boolean whaleExited = false;

////Turtle variables
//float turtleX = -850; //posisi muncul
...
//if (stingrayExited) {
//  drawWhale(whaleX, whaleY);
  whaleX -= whaleSpeedX; // Update whale position
//  if (whaleX < -250) {
//    whaleExited = true;
//  }
//}

//// Only draw and update turtle if whale has exited
//if (whaleExited) {
//  drawTurtle(turtleX, turtleY, legAngle);
//  //Update turtle position
//  turtleX += turtleSpeedX;
//  legAngle += 0.05;
//  // Check if whale has exited the screen
//  if (turtleX < -250) {
//    turtleExited = true;
//  }
//}
